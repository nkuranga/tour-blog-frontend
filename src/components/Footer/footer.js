...
const footer = () => {
  ...
  return (
    <>
      <footer className="bg-gray-50 border-t-1 dark:bg-gray-800 shadow-lg">
            ...
            <div className="w-full -mx-6 lg:w-2/5">
              <div className="px-6">
                <div>
                  <a
                    href="#"
                    className="font-bold flex items-center text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300"
                  >
